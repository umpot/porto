...
def Preprocessor(train, test):
    for col in hi_categoricals+comb_cols:
        print col
        hcc_col = 'hcc_{}'.format(col)
        train[hcc_col], test[hcc_col] = target_encode(train[col], test[col], train[target], min_samples_leaf=200, smoothing=10)
...
name = 'grid_cv_res_different_hcc_seed_110'
