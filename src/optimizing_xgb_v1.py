    ...
    def generate(self, previous_performances):
        ...
        while True:
            ...
            if key in self.cache:
                ...
                print 'From cache {} {}'.format(key, previous_performances)
                continue
            else:
                return self.counter, next_params


def perform_cv_experiments(params_generator,
                           folds_list,
                           est,
                           preprocessor,
                           metric,
    ...
    while True:
        param_id, params = params_generator.generate(previous_performances)
        if params is None:
            break
...
def try_it(grid, experiment_name):
    ...
    params_generator = GreedyPerParamParamsGenerator(grid, 3)
...
name = 'optimizing_xgb_d3_e0,1_seed110'
